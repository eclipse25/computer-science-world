...
IP는 컴퓨터 네트워크에서 데이터 패킷을 라우팅하고 전송하는 데 사용되는 프로토콜이다.
...
> **패킷 (Packet)**: "패킷"은 데이터를 라우팅 및 전송하는 데 사용되는 작은 데이터 덩어리(단위). 송신지에서 목적지로 전송되며, 주소, 제어 정보 및 페이로드 데이터를 포함한다.
...
<img src="../_assets/IPv4-format.png" alt="IPv4" width="800"/>
...
<img src="../_assets/IPv6-format.png" alt="IPv6" width="800"/>
